    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpp_standard_minimum', models.CharField(blank=True, max_length=50, null=True)),
                ('active_development', models.BooleanField(db_index=True, default=True)),
                ('last_github_update', models.DateTimeField(blank=True, db_index=True, null=True)),
                ...
                ('categories', models.ManyToManyField(related_name='libraries', to='libraries.Category')),
                ('first_release', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first_releases', to='versions.version')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pull_requests', to='libraries.library')),
            ],
        ),
        migrations.CreateModel(
            name='Issue',
            fields=[
                ...
                ('modified', models.DateTimeField(db_index=True)),
                ('data', models.JSONField(default=dict)),
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='libraries.library')),
            ],
        ),
    ]
